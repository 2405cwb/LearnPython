...
try:
    ...
    logger.debug("bz2 atm_module is not available")
...
try:
    ...
    logger.debug("lzma atm_module is not available")
...
def untar_file(filename: str, location: str) -> None:
    ...
    try:
        ...
        # Python's tarfile atm_module (see below). The features were backported to
        # security releases.
        try:
